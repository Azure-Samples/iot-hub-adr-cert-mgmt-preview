...
Licensed under the MIT license. See LICENSE file in the project root for full license information.
 ...
 IoT Hub with ADR Integration and Certificate Management Setup - Interactive, Step-by-Step
 - Press Enter to execute the step
 - Press 's' (or 'S') to skip the step
 - Ctrl + C to abort at any time

 Prerequisites:
 - Azure CLI version >= 2.42.0 installed (https://learn.microsoft.com/cli/azure/install-azure-cli)
 - Ensure you have the Azure IoT CLI extension installed
 - Replace all occurrences of '<prefix>' in the script with your desired prefix.
 - Ensure you have the privilege to create role assignments within your subscription
...
$PolicyName      = ''                       
$EnrollmentId    = ''
$WorkingFolder   = ''        #Add the path for the folder which contains this script
...
Show-Command "# az extension add --name azure-iot --allow-preview"
...
# ---------------------------
# 6) Assign Contributor to IoT Hub RP Principal at RG scope
# ---------------------------
...
# ---------------------------
# 7) Create User-Assigned Managed Identity (UAMI)
# ---------------------------
...
# ---------------------------
# 9) Assign Azure Device Registry Contributor Role to UAMI on Namespace
# ---------------------------
...
# ---------------------------
# 10) Create IoT Hub with ADR Integration
# ---------------------------
...
# ---------------------------
# 11) Manual Role Assignments on Hub for ADR Principal
# ---------------------------
...
# ---------------------------
# 12) Create DPS with ADR Integration
# ---------------------------
...
# ---------------------------
# 16) Create an enrollment group in DPS
# ---------------------------
...
# ---------------------------
# 17) Additional Useful Commands (optional)
# ---------------------------
...
# ---------------------------
# 18) Optional Cleanup | After runtime steps
# ---------------------------
